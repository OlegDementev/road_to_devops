...
-ld — Списывает саму директорию, а не её содержимое (-d останавливает команду ls от погружения внутрь директории.)
...
Основные команды управления Vim вы можете узнать и `vimtutor`:
```bash
